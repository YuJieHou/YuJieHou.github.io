!function() {
    for (var t, i = function() {}, n = ["assert", "clear", "count", "debug", "dir", "dirxml", "error", "exception", "group", "groupCollapsed", "groupEnd", "info", "log", "markTimeline", "profile", "profileEnd", "table", "time", "timeEnd", "timeStamp", "trace", "warn"], o = n.length, e = window.console = window.console || {}; o--; )
        t = n[o],
        e[t] || (e[t] = i)
}(),
    ...
    var o = {
        ...
        handleClick: function(i) {
            var o = this
              ...
              , s = t(e.hash);
            i.preventDefault(),
            s.length && (o.clearTimer(),
            "function" == typeof o.options.beforeStart && o.options.beforeStart(),
        ...
        setActiveLink: function(t) {
            ...
            i.hasClass(this.options.currentClass) || (this.$links.removeClass(this.options.currentClass),
        ...
        getCurrentSection: function(i) {
            ...
            for (n = 0; n < this.$links.length; n++)
                o = this.$links[n].hash,
                t(o).length && (e = this.getCoords(t(o)),
